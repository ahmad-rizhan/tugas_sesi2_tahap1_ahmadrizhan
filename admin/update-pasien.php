...
<head>
	<title>Update - Pasien | TesKlinik</title>
	<meta charset="utf-8">
		...
		<!-- INPUT GROUPS -->
							<div class="panel">
								<div class="panel-heading">
									<h3 style="text-align: center;">Update Pasien</h3>
								</div>
								...
								<div class="panel-body">
									<form class="" method="post" action="">
										...
										<div class="input-group">
											...
											<input class="form-control" value="<?php echo $pecah['nama_pasien']; ?>" type="text" name="nama_pasien">
										</div>
										<br>
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-calendar-check-o"></i></span>
											<input class="form-control" value="<?php echo $pecah['lahir_pasien']; ?>" type="date" name="lahir_pasien">
										</div>
										<br>
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-male"></i></span>
											<input class="form-control" value="<?php echo $pecah['keluarga_pasien']; ?>" type="text" name="keluarga_pasien">
										</div>
										<br>
										
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
											<textarea class="form-control" placeholder="<?php echo $pecah['alamat_pasien']; ?>" rows="4" value="<?php echo $pecah['alamat_pasien']; ?>" name="alamat_pasien"></textarea>
										</div>
										<br>
										...
										<div class="input-group">
											...
											<input class="form-control" value="<?php echo $pecah['telepon_pasien']; ?> "type="text" name="telepon_pasien">
										</div>
										<br>
										...
										<div class="button-group">
												...
												<a href="data-pasien.php" class="btn btn-primary"><i class="fa fa-times-circle"></i> Cancel</a>
									...
									<?php
										if (isset($_POST['update'])) {
											...
											echo "<script>document.location.href='data-pasien.php';</script>";
										}
