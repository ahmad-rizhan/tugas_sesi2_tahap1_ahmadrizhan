...
<head>
	<title>Tambah - Dokter | TesKlinik</title>
	<meta charset="utf-8">
		...
		<!-- INPUT GROUPS -->
							<div class="panel">
								...
								<div style="padding-top: 0; padding-bottom: 15px;" class="user text-center">
										<img style="width: 130px; height: 100px;" src="assets/img/img-3.png" class="image-circle" alt="Avatar">
								</div>
								...
								<div class="panel-body">
									<form method="post" action="">
										<div class="input-group">
											...
											<input class="form-control" placeholder="Nama Dokter" type="text" name="nama_dokter" autocomplete="off">
										</div>
										<br>
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-calendar-check-o"></i></span>
											<input class="form-control" placeholder="Tanggal Lahir" type="date" name="lahir_dokter">
										</div>
										<br>
										
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
											<textarea class="form-control" placeholder="ex : Jl. Panglima Soedirman No. 346 Jakarta Pusat" rows="4" name="alamat"></textarea>
										</div>
										<br>

										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-phone"></i></span>
											<input class="form-control" placeholder="Telepon" type="text" name="telepon" autocomplete="off">
										</div>
										<br>
									
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-usd"></i></span>
											<input class="form-control" placeholder="tarif" type="text" name="tarif" autocomplete="off">
										</div>
										<br>
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-stethoscope"></i></span>
											<input class="form-control" placeholder="Spesialis" type="text" name="spesialis" autocomplete="off">
										</div>
										<br>
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-align-left"></i></span>
											<textarea class="form-control" placeholder="ex : Seorang Ahli Bedah Lulusan Universitas Airlangga dan mendapatkan Pengalaman Kerja selama 5 Tahun " rows="4" name="keterangan"></textarea>
										</div>
										<br>
								...
								<?php 
										...
										
									{
										...
										$sql = mysqli_query($koneksi, "INSERT INTO dokter
											VALUES(
											' ',
											'$nama_dokter',
											'$lahir_dokter',
