...
<head>
	<title>Data - Dokter | TesKlinik</title>
	<meta charset="utf-8">
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<h3 class="page-title">Data Dokter</h3>
					
							<!-- TABLE HOVER -->
							<div class="panel">
								<div class="panel-heading">
									<a href="tambah-dokter.php" class="btn-default btn">
										<h6 class="panel-title"><i class="fa fa-user-plus" aria-hidden="true"></i> Tambah Dokter</h6>
									</a>
								</div>
									...
									<table class="table table-bordered">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo $pecah["lahir_dokter"]; ?></td>
												...
												<td>
													<a href="update-dokter.php?id=<?php echo $pecah['id_dokter']; ?>" class="btn-warning btn"><i class="fa fa-pencil"></i>
													</a> 
													| 
													<a href="hapus-dokter.php?id=<?php echo $pecah['id_dokter']; ?>" class="btn-danger btn"><i class="fa fa-trash"></i>
													</a>
												</td>
											</tr>
											<?php $no++;  ?>
