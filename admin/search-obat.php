...
<?php
	...
	$semuadata=array();
	$ambil = $koneksi->query("SELECT * FROM obat WHERE nama_obat LIKE '%$keyword%' OR kategori LIKE '%$keyword%' OR Keterangan LIKE '%$keyword%'");
					...
					<h3 class="page-title">Pencarian Data Obat</h3>
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<a href="data-obat.php" class="btn btn-default btn-lg"><i class="">Cancel</i></a>
								</div>
							</div>
				</div>
			</div>
