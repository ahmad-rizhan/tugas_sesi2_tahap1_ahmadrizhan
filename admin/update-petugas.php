...
<head>
	<title>Update - Petugas | TesKlinik</title>
	<meta charset="utf-8">
		...
		<!-- INPUT GROUPS -->
						<div class="panel">
							<div class="panel-heading">
								<h3 style="text-align: center;">Update Petugas</h3>
							</div>
							...
							<div class="panel-body">
									...
									<form class="" action="" method="post" >
										<div class="input-group">
											...
											<input autocomplete="off" class="form-control"  value="<?php echo $pecah['first_name']; ?>" type="text" name="first_name" autofocus>
										</div>
										<br>

										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-bold"></i></span>
											<input autocomplete="off" class="form-control"  value="<?php echo $pecah['last_name']; ?>" type="text" name="last_name">
										</div>
										<br>

										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-envelope"></i></span>
											<input autocomplete="off" class="form-control" value="<?php echo $pecah['email']; ?>" type="email" name="email">
										</div>
										<br>
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-phone"></i></span>
											<input autocomplete="off" class="form-control"  value="<?php echo $pecah['phone']; ?>" type="text" name="phone">
										</div>
										<br>
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-user-o"></i></span>
											<input autocomplete="off" class="form-control" type="text" name="user" value="<?php echo $pecah['user']; ?>">
										</div>
										<br>
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-lock"></i></span>
											<input autocomplete="off" class="form-control"  value="<?php echo $pecah['pass']; ?>"type="text" name="pass">
										</div>
										<br>
										<div class="input-group">
										...
										<?php
												if (isset($_POST['update'])) 
												{
													...
													$koneksi->query("UPDATE tbl_user SET
