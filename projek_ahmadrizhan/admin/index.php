...
<head>
	<title>Welcome Administrator | TesKlinik</title>
	<meta charset="utf-8">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div class="navbar-btn navbar-btn-right">
					<a class="btn btn-success update-pro" href="logout.php" title="LOGOUT"><i class=""></i> <span>LOGOUT</span></a>
				</div>
				<div id="navbar-menu">
							...
							<div class="profile">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="assets/img/kepsek.png" class="img-circle" alt="Avatar" style="height: 200px; width: 200px;">
										<h3 class="name"><?php echo $detail['user']; ?></h3>
									</div>
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<ul class="list-unstyled list-justify">
											...
											<li>First Name<span><?php echo $detail['first_name']; ?></span></li>
											<li>Last Name<span><?php echo $detail['last_name']; ?></span></li>
											<li>Email <span><?php echo $detail['email']; ?></span></li>
											<li>Phone <span><?php echo $detail['phone']; ?></span></li>
											<li>Username <span><?php echo $detail['user']; ?></span></li>
										</ul>
									</div>
									<div class="profile-info">
