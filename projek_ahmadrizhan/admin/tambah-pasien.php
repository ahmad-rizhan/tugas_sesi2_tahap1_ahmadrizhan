...
<head>
	<title>Tambah - Pasien | TesKlinik</title>
	<meta charset="utf-8">
		...
		<!-- INPUT GROUPS -->
							<div class="panel">
								<div style="padding-top: 0; padding-bottom: 15px;" class="user text-center">
										<img style="width: 100px; height: 100px;" src="assets/img/pasien.png" class="image-circle" alt="Avatar">
								</div>
								...
								<div class="panel-body">
									<form class="" method="post" action="">
										...
										<div class="input-group">
											...
											<input class="form-control" placeholder="Nama Pasien" type="text" name="nama_pasien" autocomplete="off">
										</div>
										<br>
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-calendar-check-o"></i></span>
											<input class="form-control" placeholder="Tanggal Lahir" type="date" name="lahir_pasien">
										</div>
										<br>
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-male"></i></span>
											<input class="form-control" placeholder="Keluarga Pasien" type="text" name="keluarga_pasien" autocomplete="off">
										</div>
										<br>
										
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
											<textarea class="form-control" placeholder="Masukkan Alamat" rows="4" name="alamat_pasien"></textarea>
										</div>
										<br>
										...
										<div class="input-group">
											...
											<input class="form-control" placeholder="Telepon" type="text" name="telepon_pasien" autocomplete="off">
										</div>
										<br>
