...
<head>
	...
	<title>Dashboard | TesKlinik</title>
	<meta charset="utf-8">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Klinik</h3>
							<p class="panel-subtitle">Open: Every day, 07.30 - 21.30</p>
						</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-md-3">
									<div class="metric">
										<a href="data-petugas.php"><span class="icon"><i class="fa fa-user-o"></i></span></a>
										<p>
								...
								<div class="col-md-3">
									<div class="metric">
										<a href="data-pasien.php"><span class="icon"><i class="fa fa-eye"></i></span>
										<p></a>
								...
								<div class="col-md-3">
									<div class="metric">
										<a href="data-dokter.php"><span class="icon"><i class="fa fa-stethoscope"></i></span></a>
										<p>
								...
								<div class="col-md-3">
									<div class="metric">
										<a href="data-obat.php"><span class="icon"><i class="fa fa-medkit"></i></span></a>
										<p>
											<span class="number">10</span>
