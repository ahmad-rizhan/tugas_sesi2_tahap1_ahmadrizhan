<?php
    include 'koneksi.php';
  	if (isset($_GET['kode_obat'])) {
	    ...
	    $id = ($_GET["id"]);
	    $sql = "SELECT * FROM obat WHERE id='$kode_obat'";
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" name="kode_obat" value="<?php echo $kode_obat?>">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-font"></i></span>
										<input class="form-control" value="<?php echo $nama_obat?>" type="text" name="nama_obat">
									</div>
									<br>
									<div class="input-group">
									...
									<div class="input-group">
										...
										<input class="form-control" value="<?php echo $harga_obat?>" name="harga_obat" type="text">
									</div>
									<br>

									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-folder-open-o"></i></span>
										<input class="form-control" value="<?php echo $stok?>" name="stok" type="text">
									</div>
									<br>
									...
									if (isset($_POST['update'])) {
									  ...
									  include("koneksi.php");
										...
										header("location:updateobat.php");
										?>
