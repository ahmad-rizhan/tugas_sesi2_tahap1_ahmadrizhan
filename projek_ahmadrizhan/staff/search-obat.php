...
<?php
	...
	$semuadata=array();
	$ambil = $koneksi->query("SELECT * FROM obat WHERE nama_obat LIKE '%$keyword%'");
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<div class="panel-body">	
									<table class="table table-hover">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a href="add-obat.php?id=<?php echo $perobat['id_obat']; ?>" class="btn btn-primary btn-md">Add</a> |
													<a href="detail-obat.php?id=<?php echo $perobat['id_obat']; ?>" class="btn btn-default">List</a>
												</td>
											</tr>
											<?php $no++;  ?>
											<?php endforeach ?>
									...
									<a href="biaya-obat.php" class="btn btn-default btn-lg"><i>Cancel</i></a>
								</div>
							</div>
						</div>
						<br>
