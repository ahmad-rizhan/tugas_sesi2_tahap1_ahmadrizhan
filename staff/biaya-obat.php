...
<head>
	<title>Biaya-Obat | TesKlinik</title>
	<meta charset="utf-8">
							...
							<span class="input-group-btn">
								...
								<div class="x">
									<div class="panel-heading">
										<center><b><h2>Data Obat</h2></b></center>
									</div>
								<div class="panel-body">	
									<table class="table table-hover">
										...
										<tbody>
											...
											<?php while($perobat = $ambil->fetch_assoc()){ ?> 
											

											<tr>
												<td><?php echo $no; ?></td>
												<td><?php echo $perobat['nama_obat']; ?></td>
												<td><?php echo $perobat["kategori"]; ?></td>
												<td><?php echo $perobat["stok"]; ?></td>
												<td>Rp. <?php echo number_format($perobat['harga_obat']); ?></td>
