...
<head>
	<title>Detail-Pembayaran | TesKlinik</title>
	<meta charset="utf-8">
							...
							<!-- TABLE HOVER -->
								...
								<div class="panel-body">
									<table class="table table-hover">
										...
										<tbody>
											<?php $no=1; ?>
											<?php $ambil = $koneksi ->query("SELECT * FROM pembayaran_layanan INNER JOIN pelayanan ON pembayaran_layanan.id_pelayanan=pelayanan.id_pelayanan WHERE id_bayar='$_GET[id]'");?>
											<?php while ($pecah = $ambil -> fetch_assoc()){ 
											?>
											<tr>
												<td><?php echo $no; ?></td>
										...
										<tfoot>
											...
											<tr>
												...
												<th>
													Rp. <?php echo number_format($detail['biaya_layanan']);?>
												</th>
											</tr>
										</tfoot>
									</table>
