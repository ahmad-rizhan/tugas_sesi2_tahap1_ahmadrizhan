...
<head>
	<title>Pembayaran | TesKlinik</title>
	<meta charset="utf-8">
									...
									<table class="table table-hover">
										...
										<tbody>
											...
											<?php foreach ($_SESSION['pembayaran'] as $id_obat => $jumlah): ?> 
												...
												<!-- menampilkan obat  yg sedang diperluangkan berdasarkan id_obat-->
					...
					<?php
						...
						if (isset($_POST["checkout"])) 
							...
							// 1. menyimpan data ke tabel bayar di database
								...
								foreach ($_SESSION["pembayaran"] as $id_obat => $jumlah)
								{
									$koneksi->query("INSERT INTO pembayaran_obat(id_bayar,id_obat,jumlah)VALUES('$id_pembayaran_barusan','$id_obat','$jumlah')");

									// SKrip update stok obat setelah di beli

									$koneksi->query("UPDATE obat SET stok = stok -$jumlah WHERE id_obat = '$id_obat'");
								}
